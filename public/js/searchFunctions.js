...
function generateTweetText(account, followerCount, followerText, numOfAreas) {
	...
	}${account} has ${followerCount} ${followerText}. That's more than the population of ${numOfAreas}! %23NationOfSocialMedia bit.ly/2EXWljr`
}
